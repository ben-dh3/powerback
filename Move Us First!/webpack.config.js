  ...
  return {
    ...
    resolve: {
      ...
      extensions: paths.moduleFileExtensions
        ...
        .filter(
          (ext) =>
            useTypeScript || !ext.includes('js,', 'jsx', 'ts', 'tsx')
        ),
      alias: {
        ...
        // react: path.resolve(__dirname, 'react'), STILL WORKING ON THIS
        // Support React Native Web
        // https://www.smashingmagazine.com/2016/08/a-glimpse-into-the-future-with-react-native-for-web/
        'react-native': 'react-native-web',
        // Excluding jQuery from Webpack
        jquery: path.join(paths.ownPath, './config/jquery-stub.js'),
